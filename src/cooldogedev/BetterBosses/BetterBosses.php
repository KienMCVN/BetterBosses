...
final class BetterBosses extends PluginBase
{
    ...
    protected function onEnable(): void
    {
        ...
        }, ['Zombie Boss', 'betterbosses:zombie'], EntityIds::ZOMBIE);
        ...
        }, ['Skeleton Boss', 'betterbosses:skeleton'], EntityIds::SKELETON);
        ...
        }, ['Enderman Boss', 'betterbosses:enderman'], EntityIds::ENDERMAN);
        ...
        }, ['Creeper Boss', 'betterbosses:creeper'], EntityIds::CREEPER);
        ...
        }, ['Iron Golem Boss', 'betterbosses:iron_golem'], EntityIds::IRON_GOLEM);
        ...
        }, ['Spider Boss', 'betterbosses:spider'], EntityIds::IRON_GOLEM);
        ...
        }, ['Custom Boss', 'betterbosses:custom'], EntityIds::PLAYER);
